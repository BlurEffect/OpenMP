...
*  Version of the original program modified for for parallelisation with OMP Parallel FOR but not yet using it
*/
...
void sortAll(void)
{
	...
	int numOfChunks = 1; // fastest for only 1 single chunk -> no merging necessary 
	...
	{
		// take two sub arrays, merge them and put them into the sortAllOutput array
		for(int j = 0; j < i; j+=2)
		{
